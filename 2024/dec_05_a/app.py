...
def find_correct_updates(data: str):
    sum_medians = 0
                ...
                if page == rule["left"]:
                    ...
                    for other_page_index in range(len(update)):
                        ...
                        if other_page == rule["left"] and other_page_index > page_index:
                            correct = False
        if correct:
            sum_medians += find_median_value(update)
    return sum_medians
